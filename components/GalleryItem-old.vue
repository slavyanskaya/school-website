<template>
	...
	<li class="col-md-4 col-sm-6 col-xs-12 filtr-item" :data-category="category">
		<a :href="link" :class="[{'fancybox.iframe': type === 'youtube'}, 'fancybox']" data-fancybox-group="gallery">
			<div class="mu-single-gallery">
				<div class="mu-single-gallery-item" style="position: relative">
					<div class="mu-single-gallery-img">
						<a href="#"><img alt="img" :src="thumb"></a>
					</div>
