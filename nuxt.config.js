	...
	*/
	head: {
		...
		script: [
			...
			{src: 'https://connect.facebook.net/ru_RU/sdk.js#xfbml=1&version=v13.0', nonce: 'KK8fgfqH', crossorigin: "anonymous", type: 'text/javascript', body: true, async: true, defer: true},
